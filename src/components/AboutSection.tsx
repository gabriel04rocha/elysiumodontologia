        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #375c6d 0%, #41c1bb 100%)",
                boxShadow: "0 32px 80px rgba(55,92,109,0.3)",
              }}
            >
              {/* Grid overlay */}
              <div
          ...
          >
            <div>
              ...
              <h2
                ...
                style={{ fontSize: "clamp(1.8rem, 3vw, 2.8rem)", color: "#1a2f38" }}
              >
                Por que escolher a{" "}
              ...
              <span className="divider-teal block mb-6" />
            </div>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{ background: "rgba(65,193,187,0.12)" }}
                    >
                      <Icon className="w-5 h-5" style={{ color: "#41c1bb" }} />
                    </div>
                    <p className="font-heading font-semibold text-lg" style={{ color: "#1a2f38" }}>
                      {p.title}
                    </p>
            ...
            <a
              id="about-cta"
              href="#contato"
              className="btn-teal inline-block self-start mt-2 px-8 py-3.5 text-sm font-semibold"
            >
              Conhecer a clínica →
            </a>
          </motion.div>
